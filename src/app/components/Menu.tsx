...
export default function Menu() {
  ...
  <a
    href="/"
    className={`${currentUrl === "/" ? "active-link bg-gray-900" : ""} w-44 h-10 shadow-inner cursor-pointer`}
  >
  ...
  <a
    href="/projects"
    className={`${currentUrl === "/projects" ? "active-link bg-gray-900" : ""}  w-44 h-10 shadow-inner cursor-pointer`}
  >
  ...
  <a
    href="/contact"
    className={`${currentUrl === "/contact" ? "active-link bg-gray-900" : ""}  w-44 h-10 shadow-inner cursor-pointer`}
  >
    <div className="flex flex-row p-2 gap-3 justify-center">
      <svg
        xmlns="http://www.w3.org/2000/svg"
